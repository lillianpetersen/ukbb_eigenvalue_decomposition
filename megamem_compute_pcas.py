...
plt.savefig('/tmp/eigenval_dist_'+str(nsnps)+'_x_'+str(nindv)+'.pdf')
hl.hadoop_copy('file:///tmp/eigenval_dist_'+str(nsnps)+'_x_'+str(nindv)+'.pdf', 'gs://ukb-gt/'+str(pct)+'pct/eigenval_dist_'+str(pct)+'pct_'+str(nsnps)+'_x_'+str(nindv)+'.pdf')
print('\nCREATED PLOT!\n')
